...
//				this.makeMove(possibleMoves.get(move1));
//				this.makeMove(possibleMoves.get(move2));
...
//				player.makeMove(possibleMoves.get(move1));
//				player.makeMove(possibleMoves.get(move2));
//				if (player.id == 0) {
